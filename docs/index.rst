...
`CurricularAnalytics.py <https://github.com/SheepTester-forks/CurricularAnalytics.py>`_ is a toolbox for studying, analyzing and comparing academic program curricula and their associated degree plans. The toolbox is a `Python <https://www.python.org/>`_ port of the original `CurricularAnalytics.jl <https://github.com/CurricularAnalytics/CurricularAnalytics.jl>`_. For assistance in installing the toolbox, see :doc:`install`. We welcome contributions and usage examples. If you would like to contribute to the toolbox, please see :doc:`contributing`.
