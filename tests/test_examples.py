...
class ExampleTests(unittest.TestCase):
    def test_example_1(self):
        ...
        curric = Curriculum("Example Curricula c1", c[1:])
    ...
    def test_example_2(self):
        ...
        curric = Curriculum("Example Curricula C2", c[1:])
        ...
        self.assertEqual(list(curric.blocking_factor[1].values()), [2, 1, 0, 2])
        self.assertEqual(curric.centrality[0], 6)
        self.assertEqual(list(curric.centrality[1].values()), [0, 6, 0, 0])
        self.assertEqual(curric.complexity[0], 17.0)
        self.assertEqual(list(curric.complexity[1].values()), [5.0, 4.0, 3.0, 5.0])
    ...
    def test_cornell_ee(self):
        ...
        curric = Curriculum("Cornell University EE Program", c[1:])
    ...
    def test_uh_ee(self):
        ...
        curric = Curriculum("University of Houston EE Program", c[1:])
